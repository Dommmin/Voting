...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 text-sm bg-gray-background">
        ...
        <main class="container mx-auto max-w-custom flex">
            <div class="w-70 mr-5">
                Add idea form hoes here. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus accusantium architecto autem beatae blanditiis cum dolorum enim esse iure magnam maxime mollitia optio possimus, quae, ratione reiciendis voluptatum. Aspernatur, nemo!
            </div>
            <div class="w-175">
