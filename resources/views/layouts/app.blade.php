            ...
            <div class="w-70 mr-5">
                ...
                >
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        <div>
                            <input type="text" class="text-sm w-full bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2" placeholder="Your idea" name="" id="">
                        </div>
                        <div>
                            <select name="category_add" id="category_add" class="text-sm w-full bg-gray-100 rounded-xl border-none px-4 py-2">
