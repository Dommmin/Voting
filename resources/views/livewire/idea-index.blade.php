        ...
        <div class="mt-8">
            @if($hasVoted)
                <button
                    ...
                    class="w-20 bg-blue text-white border border-gray-200 hover:bg-blue-hover font-bold transition duration-150 ease-in text-xxs uppercase rounded-xl px-4 py-3">Voted</button>
            @else
                <button
                    wire:click.prevent="vote"
                    class="w-20 bg-gray-200 border border-gray-200 hover:border-gray-400 font-bold transition duration-150 ease-in text-xxs uppercase rounded-xl px-4 py-3">Vote</button>
            @endif
        </div>
    </div>
                ...
                >
                    ...
                    >
                        ...
                        <ul
                            ...
                            class="absolute w-44 font-semibold bg-white text-left shadow-dialog rounded-xl py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0"
                        >
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    ...
                    @if($hasVoted)
                        <button
                            wire:click.prevent="vote"
                            type="button"
                            class="w-20 bg-blue border border-blue text-white font-bold text-xxs uppercase rounded-xl hover:bg-blue-hover transition duration-150 ease-in px-4 py-3 -mx-5"
                        >
                            Voted
                        </button>
                    @else
