...
>
    <div class="hidden md:block border-r border-gray-100 px-5 py-8">
        ...
        <div class="mt-8">
            @if($hasVoted)
                <button class="w-20 bg-blue text-white border border-gray-200 hover:bg-blue-hover font-bold transition duration-150 ease-in text-xxs uppercase rounded-xl px-4 py-3">Voted</button>
            @else
