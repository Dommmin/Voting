<nav class="hidden md:flex items-center justify-between text-gray-400 text-xs">
    <ul class="flex uppercase font-semibold space-x-10 border-b-4 pb-3">
        ...
        <li><a wire:click.prevent="setStatus('Open')" href="{{ route('idea.index', ['status' => 'Open']) }}" class="@if($status === 'Open') border-gray-600 text-gray-900 @endif transition duration-150 ease-in border-b-4 pb-3 hover:border-gray-600">Open ({{ $statusCount['open'] }})</a></li>
